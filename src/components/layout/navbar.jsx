...
import { Menu, LogOut, Loader2, User, Settings, LayoutDashboard, ChevronDown, Mail, Github, Linkedin, Code2 } from 'lucide-react'; // Added Mail, Github, Linkedin, Code2
...
const developerInfo = {
  ...
  linkedin: "https://www.linkedin.com/in/thakurabhisheksingh31305/",
};
  ...
  return (
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        ...
        {/* Desktop Developer Info Dropdown */}
                ...
                <DropdownMenuContent align="end" className="w-64">
                    <DropdownMenuLabel className="font-normal">
                        <div className="flex flex-col space-y-1">
                            <p className="text-sm font-medium leading-none">{developerInfo.name}</p>
                    ...
                    <DropdownMenuItem asChild>
                        <a href={`mailto:${developerInfo.email}`} className="flex items-center cursor-pointer">
                            <Mail className="mr-2 h-4 w-4" />
                            <span>Email</span>
                        </a>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                        <a href={developerInfo.github} target="_blank" rel="noopener noreferrer" className="flex items-center cursor-pointer">
                            <Github className="mr-2 h-4 w-4" />
                            <span>GitHub</span>
                        </a>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                        <a href={developerInfo.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center cursor-pointer">
           ...
           <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent side="left" className="pr-0 w-[280px] flex flex-col">
              ...
              <div className="flex-grow flex flex-col justify-between">
                ...
                {/* Developer Info Section for Mobile */}
                <div className="p-4 border-t">
                    <p className="px-3 py-2 text-xs font-semibold text-muted-foreground uppercase">Developed by</p>
                    <div className="flex flex-col space-y-1 px-3">
                        <p className="text-sm font-medium text-foreground/90">{developerInfo.name}</p>
                        <a href={`mailto:${developerInfo.email}`} className="flex items-center gap-1.5 text-xs text-foreground/70 hover:text-primary">
                            <Mail className="h-3.5 w-3.5" /> Email
                        </a>
                        <a href={developerInfo.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-foreground/70 hover:text-primary">
                            <Github className="h-3.5 w-3.5" /> GitHub
                        </a>
                        <a href={developerInfo.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-foreground/70 hover:text-primary">
