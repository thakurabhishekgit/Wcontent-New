...
type DashboardSection = 'profile' | 'update-profile' | 'post-opportunity' | 'post-collab' | 'collab-requests' | 'opportunity-apps';
...
export default function DashboardClient() {
  ...
  const sidebarLinks: { id: DashboardSection; label: string; icon: React.ElementType }[] = [
