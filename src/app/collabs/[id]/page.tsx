...
async function getCollabDetails(id: string) {
  console.log(`Fetching details for collab ID: ${id}`);
  // Simulate network delay
  await new Promise(resolve => setTimeout(resolve, 500));

  // Find the collab in the placeholder data (from collabs/page.tsx)
   const collabs = [
...
export default function CollabDetailPage() {
  ...
  const [collab, setCollab] = React.useState<any>(null); // Use specific type later
